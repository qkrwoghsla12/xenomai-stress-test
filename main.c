...
//	FilePrintEval((char *)"a.csv",BufSpinPeriodTime,BufSpinExec,BufSpinJitter,BufEcatCollect, BufEcatProcess, BufEcatTranslate,BufSpinTime,spincnt);
	FilePrintEval((char *)"/home/ubuntu/data/stress_task/a.csv",BufSpinPeriodTime,BufSpinExec,BufSpinJitter,BufEcatCollect, BufEcatProcess, BufEcatTranslate,BufSpinTime,spincnt);
